package com.example.ogbuehi.common;
...
public class Constants {
    ...
    public static final String FUNDS_CANNOT_BE_BELOW_ZERO_AFTER_TRANSACTION = "Balance cannot be lower than zero after transaction";
